<div class="container">
    ...
    @if ($showData == true)
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    @forelse ($posts as $image)
                        <tr>
                            <td>{{ $image->id }}</td>
                            <td>{{ $image->name }}</td>
                            <td><img src="{{ asset('storage') }}/{{ $image->image }}" style="width: 70px;height:70px;"
                                    alt="">
                            </td>
                            <td><button wire:click='edit({{ $image->id }})' class="btn btn-success">Edit</button>
                            </td>
                            <td>
    ...
    @if ($createData == true)
        ...
        <div class="row mt-3">
            <div class="col-xl-10 col-md-10 col-sm-12 offset-xl-1 offset-md-1 offset-sm-0">
                @if (session()->has('success'))
                    <div class="alert alert-success">
                        <strong>{{ session('success') }}</strong>
                    </div>
                    ...
                    <form action="" wire:submit.prevent='create'>
                        <div class="card-body">
                            <div class="from-group">
                                ...
                                <input type="text" wire:model='name' class="form-contro-lg form-control">
                            </div>
                ...
                <div class="card">
                    ...
                    <form action="" wire:submit.prevent='update({{ $edit_id }})'>
                        <div class="card-body">
                            <div class="from-group">
                                <label for="">Enter name</label>
                                <input type="text" wire:model='edit_name' id="name"
